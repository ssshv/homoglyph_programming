...
if (!isset($_REQUEST["address"]) || !isset($_REQUEST["ping"]) || !isset($_REQUEST["trace"]) || !isset($_REQUEST["whois"]) ) {
    "Введите данные";
    return;
}
...
$command = "whois {$address}";//add whois
$command = escapeshellcmd($command);
$string = exec($command, $arr2);
$output2 = implode("</br>", $arr2);
echo "whois :</br><b>" . $output2 . "</b>";